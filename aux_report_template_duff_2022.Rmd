...
```{r prepare_improvementteam_yn_donut}
...
team_meet<-specific_network_data_2021%>%
  ...
  mutate(Yes=sum(part_team_meetings_1))%>%
  mutate(Pct=(percent(Yes/Total, accuracy=1)))
...
Of all network members (excluding the hub), **`r team_meet$Yes`** (or **`r team_meet$Pct`**) indicated they are part of a local improvement team.
