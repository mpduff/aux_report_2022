...
network_data_2021<-specific_network_data_2021%>%
...
specific_network_data_2021$so_part_expec<-ordered(specific_network_data_2021$so_part_expec,
                                    levels=c("Much less than expected", "Somewhat less than expected", "Same as expected", "Somewhat more than expected", "Much more than expected"))
specific_network_data_2021<-specific_network_data_2021%>%
...
specific_network_data_2021$so_part_util_012021<-ordered(specific_network_data_2021$so_part_util_012021, levels=c("Not at all useful", "A little bit useful", "Moderately useful", "Useful", "Very useful", "N/A or I haven't done this activity/nin the network this school year"))
