...
```{r prepare_expect_stackbars, include=FALSE}
...
``` {r participation_expect, eval=params$expect, echo=FALSE, fig.id="expect", fig.cap="Expected participation in network activities"}
