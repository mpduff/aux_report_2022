...
`r if(params$time){"Figure # displays **how much time network members estimate they spend participating in the network weekly**."}`
...
time<-ggplot(specific_network_data_2021, aes(y=so_part_t))+
  geom_bar()
time
```
